...
class __TwigTemplate_1fa129bc5a53fa0e9867f114d8bbe6f8 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        if ((($context["controls"] ?? null) && (twig_length_filter($this->env, twig_array_batch(($context["banners"] ?? null), ($context["items"] ?? null))) > 1))) {
            ...
            echo ($context["module"] ?? null);
            echo "\" data-bs-slide=\"prev\"><span class=\"fa fa-chevron-left\"></span></button>
    <button type=\"button\" class=\"carousel-control-next\" data-bs-target=\"#carousel-banner-";
            // line 32
            echo ($context["module"] ?? null);
            echo "\" data-bs-slide=\"next\"><span class=\"fa fa-chevron-right\"></span></button>
  ";
        }
        // line 34
        echo "</div>
...
";
    ...
    {
        return new Source("", "extension/opencart/catalog/view/template/module/banner.twig", "/home/mktech/www/Ecommerce/public_html/extension/opencart/catalog/view/template/module/banner.twig");
    }
}

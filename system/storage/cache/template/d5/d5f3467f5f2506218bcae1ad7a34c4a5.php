...
class __TwigTemplate_2141207b9fc01c28a286fcc782245e37 extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["zones"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["zone"]) {
              ...
              <td class=\"text-center\"><input type=\"checkbox\" name=\"selected[]\" value=\"";
                // line 17
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "zone_id", [], "any", false, false, false, 17);
                echo "\" class=\"form-check-input\"/></td>
              <td class=\"text-start\">";
                // line 18
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "country", [], "any", false, false, false, 18);
                echo "</td>
              <td class=\"text-start\">";
                // line 19
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "name", [], "any", false, false, false, 19);
                echo "</td>
              <td class=\"text-start\">";
                // line 20
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "code", [], "any", false, false, false, 20);
                echo "</td>
              <td class=\"text-end\"><a href=\"";
                // line 21
                echo twig_get_attribute($this->env, $this->source, $context["zone"], "edit", [], "any", false, false, false, 21);
...
";
    ...
    {
        return new Source("", "admin/view/template/localisation/zone_list.twig", "/home/mktech/www/Ecommerce/public_html/admin/view/template/localisation/zone_list.twig");
    }
}

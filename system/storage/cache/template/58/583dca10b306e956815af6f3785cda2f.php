...
class __TwigTemplate_a0f522dfc1426b4861c53b91777fc1f9 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container-fluid\">
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        // line 26
        echo "                </select>
                <div class=\"input-group-text\"><i class=\"fas fa-filter\"></i>&nbsp;";
        // line 27
...
\$('#extension').on('click', '#recommended .btn-primary', function(e) {
    ...
    \$.ajax({
        ...
        echo "&extension_install_id=' + json['extension_install_id'] + '\" class=\"dropdown-item\"><i class=\"fa fa-plus-circle fa-fw\"></i> ";
        echo ($context["text_install"] ?? null);
        echo "</a> <a href=\"index.php?route=marketplace/installer|delete&user_token=";
        echo ($context["user_token"] ?? null);
        echo "&extension_install_id=' + json['extension_install_id'] + '\" class=\"dropdown-item\"><i class=\"far fa-trash-alt fa-fw\"></i> ";
...
";
    ...
    {
        return array (  300 => 201,  263 => 167,  177 => 90,  116 => 32,  108 => 27,  105 => 26,  90 => 24,  86 => 23,  78 => 18,  72 => 15,  65 => 10,  54 => 8,  50 => 7,  45 => 5,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "admin/view/template/marketplace/extension.twig", "/home/mktech/www/Ecommerce/public_html/admin/view/template/marketplace/extension.twig");
    }
}
